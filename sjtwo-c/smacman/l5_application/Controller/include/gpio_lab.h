 ...
 */
static void gpiolab__attach_interrupt(GPIO_PORT_e port, GPIO_PIN_e pin, GPIO_EDGE_e edge_type,
                                      function__void_f callback) {
...
inline static void gpiolab__disable_interrupts(void) { NVIC_DisableIRQ(GPIO_IRQn); }